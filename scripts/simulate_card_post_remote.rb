...
ENC_SECRET = { 
  ...
  :rsa_key => CreditCard.load_public_key(:passphrase => AES_PASSPHRASE, :key_file_name => "/tmp/secret.yaml")
}
@cc_data = { 
...
RestClient.post 'https://self_service_kiosk.com/store/card', signed_query
